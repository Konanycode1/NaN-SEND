                ...
                <div className="row flex-nowrap">
                    ...
                    <div className="col py-3 cardRassemblement rapportCard">
                        ...
                        <div className="card-body d-flex justify-content-between row ">
                            ...
                            <button type="button" className="btn btn-primary btnRestaurer float-sm-end"><i className="fa-solid fa-plus"></i> Tout Restaurer</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="card-body">
                            <table className="table">
                                <tbody>
                                    ...
                                    <td><button type="button" className="btn btn-primary"> Restaurer</button></td>
                                    </tr>
                                    <tr>
