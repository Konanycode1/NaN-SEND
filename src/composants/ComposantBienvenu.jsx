...
function ComposantBienvenu() {
  return (
    <>
      <div className="ConposantBienvenu">
            ...
            <div className="bienvenu1">
              ...
              <div className="bienvenu2">
                <h4>
                  ...
                  technologie et prennent en charge via la messagerie
                  instantanée, le chat Web et le courrier électronique.
                </h4>
              </div>
            </div>
          ...
          <div className="ligne-cardre">
            ...
            <div className="ligne-cardre1">
              ...
              <div className="cardre-descrip">
                ...
                <h4>
                  Avec NAN-SEND vous pouvez choisir le canal de diffusion qui
                  vous est favorables pour faciliter vos échanges et discussion,
